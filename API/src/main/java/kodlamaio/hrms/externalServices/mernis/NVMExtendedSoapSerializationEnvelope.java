...
public class NVMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NVMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NVMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NVMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NVMDateTimeConverter dateTimeConverter = new NVMStandardDateTimeConverter();

    public NVMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NVMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NVMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NVMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NVMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NVMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
