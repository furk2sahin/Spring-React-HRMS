...
@RestController
@RequestMapping("/api/v1/candidate-technologies")
@CrossOrigin
public class CandidateTechnologiesController {
    ...
    @PostMapping("/add")
    public ResponseEntity<DataResult<CandidateTechnologyGetDto>> add(
            @RequestBody @Valid CandidateTechnologyPostDto candidateTechnologyPostDto){
